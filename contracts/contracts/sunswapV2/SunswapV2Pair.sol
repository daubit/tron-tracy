...
contract SunswapV2Pair is SunswapV2ERC20, ISunswapV2Pair  {
        ...
        returns (uint amount0, uint amount1)
    {
        ...
        require(
            amount0 > 0 && amount1 > 0,
            "SunswapV2: INSUFFICIENT_LIQUIDITY_BURNED"
        );
    ...
    function swap(
        ...
        require(
            ...
            "SunswapV2: INSUFFICIENT_OUTPUT_AMOUNT"
        );
        (uint112 _reserve0, uint112 _reserve1, ) = getReserves(); // gas savings
        require(
            amount0Out < _reserve0 && amount1Out < _reserve1,
            "SunswapV2: INSUFFICIENT_LIQUIDITY"
        );
        ...
        uint balance1;
        {
            ...
            if (data.length > 0)
                ISunswapV2Callee(to).uniswapV2Call(
                    msg.sender,
                    amount0Out,
                    amount1Out,
                    data
        ...
        require(
            ...
            "SunswapV2: INSUFFICIENT_INPUT_AMOUNT"
        );
        {
